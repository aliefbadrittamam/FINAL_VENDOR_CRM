        ...
        <div class="p-8 space-y-6 bg-gray-200 rounded-lg shadow-md dark:bg-gray-800">    
            <form class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="file" id="file" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 px-3" />
                </div>
