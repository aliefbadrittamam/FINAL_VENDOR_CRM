...
<div>
    ...
    <select wire:model="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
        <option value="" disabled selected>Pilih Role</option> <!-- Placeholder -->
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-4 space-y-3">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-gray-900 mt-1">{{ $role }}</span>
                                        </div>
                                        @if(!$userId)
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div class="mt-2 text-sm text-yellow-700">
                                                            <p>
                                                                A new user account will be created with this email address. The user will be able to login using these credentials.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
