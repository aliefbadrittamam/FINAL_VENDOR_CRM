            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" wire:model="product_price"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    @error('product_price') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
                </div>
                <div>
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-4 space-y-3">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="text-gray-900">{{ $product_name }}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="font-medium text-gray-500">Category:</span>
                                        <span class="text-gray-900">{{ $category_id}}</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="font-medium text-gray-500">Price:</span>
                                        <span class="text-gray-900">{{ $product_price }}</span>
                                    </div>
